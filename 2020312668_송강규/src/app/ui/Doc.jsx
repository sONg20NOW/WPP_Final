...
import { deletePage, getNotes } from "@/actions";
...
const Doc = ({Notes, Note}) => {
  ...
  return (
    <div onClick={SelectPage} className={clsx("flex justify-between px-3",
      active ? 'bg-zinc-200' : 'bg-zinc-100',
      active ? 'hover:bg-sky-200' : 'hover:bg-zinc-200',
    )}>
      <div className={clsx("flex justify-start m-0 py-1.5 fill-zinc-500 text-zinc-500 font-bold text-sm",)}>
